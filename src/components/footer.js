...
const Footer = () => (
    <footer className="relative mt-12 p-4 bg-gradient-to-t overflow-hidden from-black/80 via-red-500/50 to-orange-300">
        <img
            className="absolute inset-0 w-full h-full -z-10 object-cover object-center"
            src="https://cdn.pixabay.com/photo/2017/01/18/21/49/singapore-1990959_960_720.jpg"
            alt="miasto nocą"
        />
        <div className="globalWrapper px-8 py-4">
            ...
            <div className="flex items-center justify-between mt-8 pt-6 border-t-[1px] border-white font-coming">
                <div>
                    {" "}
                    <Link className=" text-white" to="seovileo.pl">
                        © 2023 &middot; Wszelkie prawa zastrzeżone. Seovileo.pl
                    </Link>
                    <p className="text-white/80 text-xs">
                        Użytkowanie strony oznacza akceptację polityki cookies
                    </p>
                </div>
                <div className="flex items-center">
                    ...
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-6 w-auto fill-white ionicon"
                            viewBox="0 0 512 512"
                        >
                    ...
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-7 w-auto fill-red-600 ionicon"
                            viewBox="0 0 512 512"
                        >
